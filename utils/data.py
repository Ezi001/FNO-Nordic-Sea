...
def nordic_ar_dataset(
    ...
    return (
        ...
        y_state.reshape(-1, *y_state.shape[2:])
    )

def load_nordic_seas_data(path):
...
def build_trajectories(data, window_size, stride):
    """
    To generate windows
    """
    trajectories = []
