...
from utils.data_torch import build_dataloader, linear_spline, quintic_spline_batch, load_partial_data, CudaPrefetcher
...
def main() -> None:
    ...
    input_shape = tuple(train_state.shape[2:])
